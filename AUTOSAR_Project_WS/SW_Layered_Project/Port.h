...
#define PORT_RANGE_OF_PIN_MODE					(10U)
/******************************************************************************
...
typedef struct
{
	...
	Port_PinInitLevelType initlevel; //used to set the initial values if the pin is output pin or enable/disable the pullup resistance if the pin is input pin
}Port_Config;
